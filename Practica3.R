...
datos - read.csv(CUsersChira CiprianOneDrive - Universidad de AlmeriaUAL4 INGSegundoCuatriEstadísticaPrácticasPráctica 1notasA3.csv, sep=,, dec=,, header=T);
...
datos$Practica1 - ifelse(datos$Practica1 = 13, Aprobado, Suspenso)
datos$Practica2 - ifelse(datos$Practica2 = 13, Aprobado, Suspenso)
datos$Practica3 - ifelse(datos$Practica3 = 13, Aprobado, Suspenso)
